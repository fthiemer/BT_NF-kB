...
with open(os.path.join(".","data", "All_infos_gene_summary.txt"), "w+", newline = "") as f:
...
with open(os.path.join(".","data", "gene_top_QSs.txt"), "w+", newline = "") as f:
    thresholdFile = csv.writer(f, delimiter = "\t")
    thresholdDict = {}
...
# 
with open(os.path.join(".","data", "gene_top_QSs_motif_separated.txt"), "w+", newline = "") as f:
    thresholdFile = csv.writer(f, delimiter = "\t")
    thresholdDict = {}
...
with open(os.path.join(".", "data", "ABC_and_final_motif_specific_QSs.txt"), "w+", newline = "") as f:

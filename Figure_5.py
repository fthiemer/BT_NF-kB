...
fig.savefig(os.path.join(".", "Figures","figure6_version2_chromosomal_localisation.png"), dpi = 600)
...
total = 0
for chr in xticksList:
	actualFile = openWriteableCSV(os.path.join(".", "Figures", "data_for_hussam", chr + ".txt"))

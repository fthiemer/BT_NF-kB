...
with open(os.path.join(".", "important_source_files", "20180809_EPD_data_v6_analyzed", 
"all_data.txt"), newline = "") as f:
...
plt.legend()
fig.savefig(os.path.join(".", "Figures", "Figure_3_ver2.png"), dpi = 600)